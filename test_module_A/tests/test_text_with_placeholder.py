...
class TestTextWithPlaceholder(unittest.TestCase):
    def setUp(self):
    ...
    def test_text_with_placeholder(self):
        ...
        driver.find_element_by_id("blank-text").clear()
        driver.find_element_by_id("blank-text").send_keys(u"#[1]# and the second placeholder ")
        driver.find_element_by_css_selector("button.btn.btn-success").send_keys(Keys.ENTER)
        text = driver.find_element_by_id("blank-text").get_attribute('value')
        self.assertEqual(text,"#[1]# and the second placeholder #[2]#")
