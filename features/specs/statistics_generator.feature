Feature: StatisticsGenerator
  ...
  Scenario: Trying to create an volume problem with invalid range
    Given I am logged with a fresh class, created a test and accessed question generator
    Then I select the volume problem generator
    Then I enter "50" elements asked
  ...
  Scenario: Trying to create an volume problem with too small range
    Given I am logged with a fresh class, created a test and accessed question generator
    Then I select the volume problem generator
    Then I enter "50" elements asked
  ...
  Scenario: Trying to create an volume problem with negative amount of elements asked
    Given I am logged with a fresh class, created a test and accessed question generator
    Then I select the volume problem generator
